...
/*
	...
	Text Domain: woocommerce-taxamo
...
class WooCommerce_Taxamo {
	...
	/**
	 * Enqueue the Admin CSS scripts
	 */
	public function enqueue_admin_css() {
		wp_enqueue_style(
			'wc_taxamo_admin_css',
			plugins_url( '/assets/css/woocommerce-taxamo-admin.css', WooCommerce_Taxamo::get_plugin_file() ),
			array(),
			'1.0'
		);
	}
	...
	/**
	 * Enqueue the Admin JS scripts
	 */
	public function enqueue_admin_js() {
		wp_enqueue_script(
			'wc_taxamo_admin_js',
			plugins_url( '/assets/js/admin-order-view.js', WooCommerce_Taxamo::get_plugin_file() )
		);
	}
