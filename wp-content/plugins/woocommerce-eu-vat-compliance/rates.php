...
// 						var p_rate = jQuery(line).find('.wc_input_country_rate');
				...
				var tax_description = ' <?php esc_attr_e('Description:', 'wc_eu_vat_compliance');?> <input id="euvatcompliance-whatdescription" title="<?php esc_attr_e('The description that will be used when using the button for mass adding/updating of EU rates', 'wc_eu_vat_compliance'); ?>" type="text" size="6" value="VAT">';

				$foot.after('<?php echo esc_js(__('Use rates:', 'wc_eu_vat_compliance')); ?> '+rate_selector+tax_description);
...
// 					jQuery.blockUI({ message: "<h1><?php esc_attr_e('Adding tax rates...', 'wc_eu_vat_compliance');?></h1>" });
